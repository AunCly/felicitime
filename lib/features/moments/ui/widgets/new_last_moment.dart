...
class NewLastMoment extends StatefulWidget {
  const NewLastMoment({super.key, required this.moment, required this.deleteAction, required this.showAction, required this.favoriteAction});
  ...
  @override
  State<NewLastMoment> createState() => _NewLastMomentState();
}

class _NewLastMomentState extends State<NewLastMoment> {
  @override
